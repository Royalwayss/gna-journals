<?php
$pageTitle   = 'Editorial Advisory Board';
$currentPage = 'advisory-board';
...
<h1 class="page-title">Editorial Advisory Board</h1>
      <div class="advisory-group"><div class="group-label">Chief Patron</div><div class="board-card"><div class="bc-avatar">GS</div><div class="bc-info"><div class="bc-name">S. Gurdeep Singh Sihra</div><div class="bc-meta">Chancellor, GNA University</div></div></div></div>
      <div class="advisory-group"><div class="group-label">Patron</div><div class="board-card"><div class="bc-avatar">KS</div><div class="bc-info"><div class="bc-name">S. Keerat Singh Sihra</div><div class="bc-meta">President, GNA University</div></div></div></div>
      <div class="advisory-group"><div class="group-label">Co-Patron</div><div class="board-card"><div class="bc-avatar">HS</div><div class="bc-info"><div class="bc-name">Dr. Hemant Sharma</div><div class="bc-meta">Vice Chancellor, GNA University</div></div></div></div>
      <div class="advisory-group"><div class="group-label">Members</div>
        <div class="members-grid">
          ...
          <div class="member-item"><h4>Dr. Ramesh Chandan Dalia</h4><p>Kurukshetra University</p></div>
          <div class="member-item"><h4>Dr. Jatinder Singh</h4><p>GNDU Amritsar</p></div>
          <div class="member-item"><h4>Dr. Sita Rani</h4><p>Guru Nanak Dev Engineering College, Ludhiana</p></div>
        </div>
      </div>
    </main>
  </div>
