...
<footer>
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <div class="footer-logo-wrap">
          <img src="images/gna_university_logo.png.png" alt="GNA University">
        </div>
      ...
      <div class="footer-col">
        ...
        <div class="footer-contact-item">
          ...
          <span>01824-504999 &nbsp;|&nbsp; 70873-02404</span>
        </div>
        ...
        <div class="footer-contact-item">
          ...
          <a href="mailto:Gna.journal@gnauniversity.edu.in" class="footer-mail-link">Gna.journal@gnauniversity.edu.in</a>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <p>© 2024 GNA University. All rights reserved. Published by S. Amar Singh Charitable Trust, Jalandhar.</p>
